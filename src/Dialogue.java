...
public class Dialogue extends JPanel {
   ...
   private Image textBox; //pretty little textbox   
   ...
   */
   ...
   protected void paintComponent(Graphics g) {
      ...
      if(dialogueIndex%2 != 0){
         //ta.setText("\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n"+texts[dialogueIndex/2]);
         //g.drawString(texts[dialogueIndex/2].substring(0, typeWriterIndex), 100, 500);
         write(g, texts[dialogueIndex/2], 100, 500);
      } else {
         //ta.setText("\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n"+texts[dialogueIndex/2].substring(0, typeWriterIndex));
         //ta.paint(g2);
         //g.drawString(texts[dialogueIndex/2], 100, 500);
         write(g, texts[dialogueIndex/2].substring(0, typeWriterIndex), 100, 500);
